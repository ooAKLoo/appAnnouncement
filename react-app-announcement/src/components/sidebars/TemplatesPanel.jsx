            ...
            <div className="relative bg-gray-50/80 p-1 rounded-xl border border-gray-200/50">
              <div className="flex gap-1">
                {deviceTypes.map((device) => (
                  <button
                    key={device.id}
                    className={`relative flex items-center gap-2 px-3 py-2 rounded-lg transition-all duration-300 whitespace-nowrap flex-1 ${
                  ...
                  >
                    <device.icon size={14} className={`transition-colors duration-200 ${
