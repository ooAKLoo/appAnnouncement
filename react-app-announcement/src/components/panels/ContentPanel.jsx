...
import { Image, MonitorSpeaker, Plus, Trash2, GripVertical, FileText, X } from 'lucide-react';
...
function ContentPanel({ isActive }) {
  const { state, updateAppInfo, updateDownloads, updateFeatures, updateEventInfo, toggleConfigPanel } = useApp();
